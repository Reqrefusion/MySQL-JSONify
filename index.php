<div
    style='background:lightblue; color:white; border: orange solid 1px; width:900px; margin:auto; text-align:center; height:100%;'>
    ...
    */
    ...
    <div style="background:white; color:orange; width:49.75%; float:left; min-height:500px; border-right: solid 1px;">
        ...
        <ul>
            ...
            <li><a style="color:orange;" href="<?= "$url?order=asc," . $data->tableRows[1] . "" ?>">
                    ?order=asc,<?= $data->tableRows[1] ?></a></li>
            <li><a style="color:orange;"
                   href="<?= "$url?order=desc," . $data->tableRows[1] . ";asc," . $data->tableRows[2] . "" ?>">
                    ?order=desc,<?= $data->tableRows[1] ?>;asc,<?= $data->tableRows[2] ?></a></li>

            -----

            <li><a style="color:orange;"
                   href="<?= "$url?select=" . $data->tableRows[0] . "" ?>">?select=<?= $data->tableRows[0] ?></a></li>
            <li><a style="color:orange;"
                   href="<?= "$url?select=" . $data->tableRows[1] . "" ?>">?select=<?= $data->tableRows[1] ?></a></li>
            <li><a style="color:orange;" href="<?= "$url?select=" . $data->tableRows[0] . "," . $data->tableRows[1] ?>">?select=<?= $data->tableRows[0] ?>
                    ,<?= $data->tableRows[1] ?></a></li>
            ...
            <li><a style="color:orange;"
                   href="<?= "$url?filter=the," . $data->tableRows[1] . ",like,and;an," . $data->tableRows[2] . ",not like" ?>">
                    ?filter=the,<?= $data->tableRows[1] ?>,like,and;an,<?= $data->tableRows[2] ?>,not like</a></li>
